...
extern int  sort_next    (sort_t * sort, int height);
...
extern void history_good (int move, const board_t * board, int height);
extern void history_bad  (int move, const board_t * board, int height);
