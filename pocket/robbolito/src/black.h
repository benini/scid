...
#define RANK_FOUR_EIGHT_noH (0x0000007f7f7f7f7full)
#define RANK_FOUR_EIGHT_noA (0x000000fefefefefeull)
...
#define your_pawn(x) ((x==count_pawn_white)?0xffffffffffffffffull:0)
