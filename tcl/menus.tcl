...
$m add command -label OptionsSave -command {
  ...
  if {[catch {open [scidConfigFile options] w} optionF]} {
    ...
    # save FICS config
    foreach i { use_timeseal timeseal_exec port_fics port_timeseal login password consolebg consolefg consoleheight consolewidth colseeking colgame colgameresult colficspercent} {
