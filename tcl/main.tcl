...
proc CreateMainBoard { {w} } {
  ...
  options.persistent ::showScorebar($w) 0
  if {$::showScorebar($w)} { ::board::toggleScorebar $w.board }
  ...
  set ::gameInfoBar(tb_BD_Scorebar) "set ::showScorebar($w) \[::board::toggleScorebar $w.board\]"
