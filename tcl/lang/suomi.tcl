...
helpMsg U .main.fbutton.button.forward {Eteenpäin yksi siirto  (pika: Oikea nuoli)}
...
helpMsg U .main.fbutton.button.flip {Käännä lauta  (pika: piste)}
...
menuText U RepFileSaveAs "Tallenna nimellä..." 4
menuText U RepFileClose "Sulje ikkuna" 0
menuText U RepEdit "Muokkaa" 0
menuText U RepEditGroup "Lisää ryhmä" 3
menuText U RepEditInclude "Lisää mukaan otettava linja" 0
menuText U RepEditExclude "Lisää poistettava linja" 0
menuText U RepView "Näytä" 0
menuText U RepViewExpand "Laajenna kaikki ryhmät" 0
menuText U RepViewCollapse "Pienennä kaikki ryhmät" 0
menuText U RepSearch "Haku" 0
menuText U RepSearchAll "Kaikkialta..." 0
menuText U RepSearchDisplayed "Vain näytetyistä riveistä..." 0
...
translate U RepCloseDialog {Tässä repertuaarissa on tallentamattomia muutoksia.

Haluatko jatkaa ja hylätä tekemäsi mutokset?
}
